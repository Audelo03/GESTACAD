...
<div class="container mt-4">
    <div class="row mb-3">
        <div class="col-md-6">
            <button class="btn btn-success" id="btnNuevaDivision">
                <i class="bi bi-plus-circle"></i> Agregar División
            </button>
        </div>
    </div>

    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover" id="tablaDivisiones">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel">Formulario de División</h5>
        ...
        const renderTable = (data) => {
            ...
            data.forEach(item => {
                ...
                <tr>
                    ...
                    <td>${item.nombre}</td>
                    <td>
                        <button class="btn btn-sm btn-warning btn-editar" data-id="${item.id}" data-nombre="${item.nombre}"><i class="bi bi-pencil"></i></button>
