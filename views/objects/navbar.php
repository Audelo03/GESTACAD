...
?>
<nav id="navbar1" class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
    <div class="container-fluid">
        ...
        <span class="navbar-brand small fw-normal breadcrumb-brand">
            ...
            <span class="text-muted d-none d-sm-inline">GESTACAD</span>
            <i class="bi bi-chevron-right mx-1 text-muted d-none d-sm-inline"></i>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarUserDropdown"
                        ...
                        <span
                            class="d-none d-sm-inline"><?php echo htmlspecialchars($_SESSION['usuario_nombre'] ?? 'Usuario'); ?></span>
                        <span class="d-sm-none">Usuario</span>
                    </a>

                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2"
                        aria-labelledby="navbarUserDropdown">
                        <li>
                            <a class="dropdown-item" href="/GESTACAD/profile.php">
                        ...
                        <li>
                            <a class="dropdown-item text-danger" href="/GESTACAD/logout" id="logout-link">
